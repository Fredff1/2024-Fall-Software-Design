...
public class ConsoleHtmlInsertCommand implements ConsoleCommand{
    ...
    public ConsoleHtmlInsertCommand(HtmlDocument document,String tagName,String targetId,String brotherId,String content){
